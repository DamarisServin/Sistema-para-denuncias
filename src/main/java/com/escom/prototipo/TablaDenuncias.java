 ...
 * @author damar
 */
public class TablaDenuncias extends javax.swing.JFrame {
     ...
     */
    public TablaDenuncias(boolean b) {
        isCoordinador = b;
...
//        String aux;
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(BIFDD, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void ExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExportActionPerformed
        ...
        try (FileOutputStream outputStream = new FileOutputStream("output.xlsx")) {
            ...
            JOptionPane.showMessageDialog(null, "Archivo Excel creado exitosamente", "Archivo Descargado", JOptionPane.WARNING_MESSAGE);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (col == 6) {
            ...
            JOptionPane.showMessageDialog(null, "El archivo ha sido descargado", "Archivo Descargado", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaDenuncias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaDenuncias(true).setVisible(true);
            }
        });
    }
